<div>
    <?php $maintenanceOn = config('settings.maintenance_mode') && !(auth()->check() && auth()->user()?->hasRole(['admin', 'instructor'])); ?>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($maintenanceOn): ?>
    ...
    <section class="max-w-7xl mx-auto px-6 py-20" id="featured-courses">
        <div class="flex flex-col items-center justify-center text-center py-16 gap-6 border border-dashed border-rule rounded-2xl bg-surface">
            ...
            <div class="flex flex-col gap-3 max-w-md">
                <h2 class="text-2xl font-bold font-display text-ink"><?php echo e(\App\Models\Setting::get('maintenance_coming_soon_title', 'Coming Soon')); ?></h2>
