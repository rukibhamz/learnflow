            ...
            <div x-show="activeTab === 'general'" class="p-10 space-y-12">
                ...
                <div class="space-y-10 pt-10 border-t border-rule">
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="flex flex-col md:flex-row md:items-start gap-6 pt-6 border-t border-rule/50">
                            <div class="md:w-1/2 space-y-1">
                                <label class="block text-[13px] font-bold text-ink font-poppins">Coming Soon Title</label>
                                <p class="text-[12px] text-ink3 font-sans leading-relaxed">The heading shown on maintenance pages (e.g. "Coming Soon").</p>
                            </div>
                            <div class="md:w-1/2">
