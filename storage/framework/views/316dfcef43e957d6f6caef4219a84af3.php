...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.auth-session-status','data' => ['class' => 'mb-4 text-sm text-green-600 dark:text-green-400','status' => session('status')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mb-4 text-sm text-green-600 dark:text-green-400','status' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(session('status'))]); ?>
...
<?php endif; ?>
    ...
    <form method="POST" action="<?php echo e(route('login.post')); ?>" class="space-y-6">
        ...
        <div class="space-y-1.5">
            ...
            <input id="login" name="login" type="text" value="<?php echo e(old('login')); ?>" placeholder="johndoe or name@company.com" required autofocus autocomplete="username"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('login'),'class' => 'mt-1 text-sm text-red-600']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
        ...
        <div class="flex items-center justify-between">
            ...
            <a class="text-[11px] text-primary hover:underline font-medium uppercase tracking-wider" href="<?php echo e(route('password.request')); ?>">Forgot password?</a>
        </div>
    ...
    <p class="mt-8 text-center text-xs text-neutral-text dark:text-slate-500">
        New to LearnFlow? <a class="text-primary font-bold hover:underline" href="<?php echo e(route('register')); ?>" wire:navigate>Create an account</a>
    </p>
</div><?php /**PATH C:\xampp\htdocs\learnflow\resources\views\livewire/pages/auth/login.blade.php ENDPATH**/ ?>