...
<?php
    $icons = [
        'school' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l9-5-9-5-9 5 9 5z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z"/>',
        ...
        'star-filled' => '<path fill-rule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.007 5.404.433c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.433 2.082-5.006z" clip-rule="evenodd"/>',
    ...
    $path = $icons[$name] ?? '';
    $isFilled = $filled || str_ends_with($name, '-filled');
?>
<svg <?php echo e($attributes->merge(['class' => $class, 'fill' => $isFilled ? 'currentColor' : 'none', 'stroke' => $isFilled ? 'none' : 'currentColor', 'viewBox' => '0 0 24 24'])); ?> xmlns="http://www.w3.org/2000/svg">
    <?php echo $path; ?>

</svg>
<?php /**PATH C:\xampp\htdocs\learnflow\resources\views/components/icon.blade.php ENDPATH**/ ?>