    ...
    <div class="px-6 md:px-10 py-16">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-16">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    ...
                    <li><a href="{{ route('pages.mentors') }}" class="text-sm hover:text-white transition-colors">Mentors</a></li>
                    <li><a href="{{ route('pages.pricing') }}" class="text-sm hover:text-white transition-colors">Pricing</a></li>
                    <li><a href="{{ route('pages.resources') }}" class="text-sm hover:text-white transition-colors">Resources</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    ...
                    <li><a href="{{ route('blog.index') }}" class="text-sm hover:text-white transition-colors">Blog</a></li>
                    <li><a href="{{ route('pages.contact') }}" class="text-sm hover:text-white transition-colors">Contact</a></li>
                    <li><a href="{{ route('register') }}" class="text-sm hover:text-white transition-colors">Become an Instructor</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="{{ route('pages.help') }}" class="text-sm hover:text-white transition-colors">Help Center</a></li>
                    <li><a href="{{ route('pages.terms') }}" class="text-sm hover:text-white transition-colors">Terms of Service</a></li>
                    <li><a href="{{ route('pages.privacy') }}" class="text-sm hover:text-white transition-colors">Privacy Policy</a></li>
                    <li><a href="{{ route('pages.contact') }}" class="text-sm hover:text-white transition-colors">Cookie Policy</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="border-t border-slate-800 mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-6">
                <a href="{{ route('pages.terms') }}" class="text-slate-500 text-sm hover:text-white transition-colors">Terms</a>
                <a href="{{ route('pages.privacy') }}" class="text-slate-500 text-sm hover:text-white transition-colors">Privacy</a>
                <a href="{{ route('pages.contact') }}" class="text-slate-500 text-sm hover:text-white transition-colors">Cookies</a>
            </div>
        </div>
    </div>
</footer>
