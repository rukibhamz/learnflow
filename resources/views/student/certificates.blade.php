...
<div class="max-w-5xl mx-auto">
    <div class="mb-10 flex items-center justify-between">
        ...
        <a href="{{ route('home') }}" class="px-5 py-2.5 bg-accent text-white font-display font-bold text-[12px] rounded-card hover:opacity-90 transition-opacity">Explore Courses</a>
    </div>
